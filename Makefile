...
# Force module mode to avoid vendoring issues
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name clusterscan-operator-builder
	$(CONTAINER_TOOL) buildx use clusterscan-operator-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm clusterscan-operator-builder
	rm Dockerfile.cross
